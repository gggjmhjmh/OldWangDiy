...
public class BottomListDialog2 extends Dialog {
...
//        setCanceledOnTouchOutside(true);
    ...
    public BottomListDialog2 setData(String title, List<String> dataList) {
     ...
     */
    public BottomListDialog2 setDataObj(String title, List<Object> dataList, String memberName) {
     ...
     */
    public BottomListDialog2 setDataObj(String title, List<ItemShowText> dataList) {
        return setData(title, dataList, null);
    }
     ...
     * @param memberName 成员变量名称,取该成员的值作为显示文本
     */
    private BottomListDialog2 setData(String title, List dataList, String memberName) {
    ...
    public BottomListDialog2 setSelectIndex(int selectIndex) {
        adapter.setSelcetIndex(selectIndex);
        adapter.notifyDataSetChanged();
        return this;
    }

    public BottomListDialog2 setSelectImg(int imgResId) {
    ...
    class DialogListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (null == convertView) {
                hv = new MyViewHolder();
                convertView = inflater.inflate(R.layout.item_dialog_bottom_list2, null, false);
